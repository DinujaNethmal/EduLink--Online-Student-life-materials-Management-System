  ...
  return (
    <div className="my-listings container">
      <div className="listings-header">
        ...
        <Link to="/sell" className="btn btn-gold">
      ...
      {products.length === 0 ? (
        <div className="empty-state">
          ...
          <Link to="/sell" className="btn btn-primary btn-lg">List Your First Item</Link>
        </div>
      ) : (
              ...
              {products.map((p) => (
                <tr key={p._id}>
                  ...
                  <td className="actions-cell">
                    <Link to={`/edit-product/${p._id}`} className="btn btn-sm btn-outline" title="Edit">
                      <FiEdit2 size={14} />
                    </Link>
